...
if [ ! -f ".env" ]; then
    ...
    echo ""
    echo "IMPORTANT: Edit .env and add your Picovoice access key:"
    echo "  PICOVOICE_ACCESS_KEY=your_key_here"
    echo ""
    echo "Get your free API key at: https://console.picovoice.ai/"
    echo ""
else
    echo ""
...
echo ""
echo "Next steps:"
echo "  1. Edit .env and add your Picovoice API key"
